...
export default {
    ...
    async fetch() {
      const organization = this.$auth.$storage.getUniversal('organization')
      const team = this.$auth.$storage.getUniversal('team')
      this.teams = organization.teams.map(x => ({...x,current:x.id === team.id}))
    },
    ...
    methods: {
        async selectTeam(team){
          this.$auth.$storage.setUniversal('team',team)
        ...
        >
          ...
          <li>
            ...
            >
              ...
              <span>{{ $auth.$storage.getUniversal('organization').name }}</span>
            </nuxt-link>
          </li>
          ...
          >
            <template slot="button-content">
              <a>
                ...
                <span>{{ $auth.$storage.getUniversal('team').name }}</span>
              </a>
            </template>
            <li
              v-for="(team) in teams"
            ...
            >
              ...
              >
                <i class="ri-group-2-line noti-icon mr-1" />
                <span class="my-auto">{{ team.name }}</span>
              </a>
            </li>
            <li>
              <!-- crate new team button -->
              <nuxt-link to="/account-settings/clinic-settings/teams/create">
                <a class="dropdown-item d-flex text-primary rounded">
                  <i class="ri-add-line noti-icon mr-1" />
                  <span class="my-auto">Create New Team</span>
                </a>
              </nuxt-link>
            </li>
          </b-nav-item-dropdown>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <li
                          v-for="(subSubitem, index2) of subitem.subItems"
                          :key="index2"
                        >
                          <nuxt-link
                            :to="subSubitem.link"
