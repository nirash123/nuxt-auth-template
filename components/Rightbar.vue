    ...
    >
      <simplebar class="h-100">
        ...
        >
          <b-tab>
            <template #title>
              <i class="mdi mdi-message-text-outline d-block font-22 my-1" />
            </template>
            ...
            <div class="p-2">
              ...
              >
                <i class="mdi mdi-checkbox-blank-circle-outline mr-1 text-success" />
              ...
              <a
                ...
                class="text-reset notification-item pl-3 mb-2 d-block"
              >
                <i class="mdi mdi-checkbox-blank-circle-outline mr-1 text-warning" />
              ...
              <a
                ...
                class="text-reset notification-item pl-3 mb-2 d-block"
              >
                <i class="mdi mdi-checkbox-blank-circle-outline mr-1 text-danger" />
              ...
              >
                <i class="mdi mdi-checkbox-blank-circle-outline mr-1" />
            ...
            <h6 class="font-weight-medium px-3 mt-3 text-uppercase">
              ...
              ><i class="float-right mdi mdi-plus-circle" /></a>
            </h6>
            ...
            <div class="p-2 pb-4">
              ...
              <div class="text-center mt-3">
                ...
                >
                  <i class="mdi mdi-spin mdi-loading mr-2" />
                  Load more
                </a>
              </div>
            </div>
          ...
          <b-tab>
            <template #title>
              <i class="mdi mdi-format-list-checkbox d-block font-22 my-1" />
            </template>
          ...
          <b-tab active>
            <template #title>
              <i class="mdi mdi-cog-outline d-block font-22 my-1" />
            </template>
            ...
            <div class="p-3">
              ...
              <a
                ...
                target="_blank"
              ><i class="mdi mdi-basket mr-1" /> Purchase Now</a>
            </div>
          </b-tab>
        </b-tabs>
        <!-- Nav tabs -->
